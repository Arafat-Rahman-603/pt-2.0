  ...
  return (
    <footer className="relative bg-gray-950 overflow-hidden">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent 0%, rgba(6,182,212,0.6) 30%, rgba(139,92,246,0.6) 70%, transparent 100%)",
        }}
      />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-16 py-14">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-10">
          ...
          >
            ...
            <p className="text-xs text-gray-500 max-w-[220px] text-center md:text-left leading-relaxed">
        ...
        >
          <p className="text-xs text-gray-600">
            © {year}{" "}
            <span className="text-gray-400 font-medium">Arafat Rahman</span>.
            All rights reserved.
          </p>
          <p className="text-xs text-gray-600">
            Designed &amp; Built with{" "}
